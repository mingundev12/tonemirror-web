       ...
       <>
            <div className={`md:scale-100 scale-90 flex flex-row gap-1.5 md:gap-2 justify-center items-center font-semibold font-roboto max-w-full ${isDiagStep ? "shrink-0 mb-4 md:mb-0" : ""}`}>
                ...
                <div className="relative">
                    ...
                    <p className={`${diagStatus === "ready" ? "text-[#3D2E35]" : "text-[#3D2E35]/50"} font-medium absolute left-1/2 -translate-x-1/2 w-max pt-2 text-center text-sm font-gmarket`}>{indicatorConst[0]}</p>
                </div>
                ...
                <div className="relative">
                    ...
                    <p className={`${diagStatus === "upload" ? "text-[#3D2E35]" : "text-[#3D2E35]/50"} font-medium absolute left-1/2 -translate-x-1/2 w-max pt-2 text-center text-sm font-gmarket`}>{indicatorConst[1]}</p>
                </div>
                ...
                <div className="relative">
                    ...
                    <p className={`${diagStatus === "analysis" ? "text-[#3D2E35]" : "text-[#3D2E35]/50"} font-medium absolute left-1/2 -translate-x-1/2 w-max pt-2 text-center text-sm font-gmarket`}>{indicatorConst[2]}</p>
                </div>
