...
export default function PictureGuideNote({HologramOverlay, GUIDE_SECTIONS}) {
   return (
       <>
        <div className="glass flex flex-col h-full min-h-0 w-full rounded-2xl border border-[#FDFAF7]/10 font-gmarket relative p-4">
            <HologramOverlay />
            ...
            {GUIDE_SECTIONS.map((section) => (
                ...
                <ul className="flex flex-col gap-2.5 ml-3 text-sm leading-snug text-[#3D2E35]/75">
