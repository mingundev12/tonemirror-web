       ...
       <>
           <div className="grid md:grid-cols-3 grid-cols-2 md:gap-0 gap-2 place-items-center w-full">
                <motion.button
                    ...
                    <p className="font-light pt-1 font-gmarket">{t.resultLeftConst[1]}</p>
                </motion.button>
                <motion.button
                    whileHover={{ scale: 1.05, backgroundColor: "#5C4650" }}
                    transition={{ duration: 0.2, ease: "easeInOut", type: "spring", damping: 10, stiffness: 100}}
                    ...
                    <p className="font-light pt-1 font-gmarket">{t.resultLeftConst[2]}</p>
                </motion.button>
                <motion.button
                    ...
                    <p className="pt-1 font-gmarket">{t.resultLeftConst[3]}</p>
                </motion.button>
            </div>
       </>
   )
