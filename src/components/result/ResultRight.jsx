           ...
           <div className="glass relative flex flex-col gap-4 items-center justify-center rounded-2xl border border-[#FDFAF7]/10 overflow-hidden p-10">
                ...
                <div className="grid grid-cols-2 md:gap-20 gap-10 w-full h-full relative">
                    <div className="h-full flex flex-col gap-2  justify-center">
                        <p className="text-[#3D2E35]/75 tracking-widest text-left pt-1 text-xs font-light font-gmarket">{resultRightConst[0]}</p>
                    ...
                    <div className="h-full">
                        <p className="text-[#3D2E35]/75 tracking-widest text-left pt-1 text-xs font-light font-gmarket">{resultRightConst[1]}</p>
                        <div className="h-full justify-center flex items-center flex-col gap-2">
                            ...
                            <p className="text-[#3D2E35] font-light md:text-base text-sm text-center font-gmarket">{resultRightConst[2][0]} <br className="md:hidden block" /> {resultRightConst[2][1]} </p>
                        </div>
                    </div> 
                </div>
                ...
                <hr className="border-[#3D2E35]/20 h-[0.1px]" />
                    <div className="flex flex-col justify-center gap-2 items-start px-2">
                        <p className="text-[#3D2E35]/75 text-xs font-light font-gmarket">{resultRightConst[3]}</p>
                    ...
                    <div className="flex flex-col justify-between w-full items-start gap-2 px-2">
                        <p className="text-[#3D2E35]/75 text-xs font-light font-gmarket">{resultRightConst[4]}</p>
